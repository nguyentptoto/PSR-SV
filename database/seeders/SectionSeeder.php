...
class SectionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('sections')->insert([
            ...
            ['name' => 'Information Technology (DA)', 'code' => 'IT1-DA', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Information Technology (HY)', 'code' => 'IT2-HY', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Information Technology (VP)', 'code' => 'IT3-VP', 'created_at' => now(), 'updated_at' => now()],
