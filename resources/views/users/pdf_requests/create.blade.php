                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="pia_code" id="pia_code" class="form-control" value="{{ old('pia_code') }}" required>
                                    @error('pia_code')
...
<div class="form-check mt-3 mb-3">
    <input class="form-check-input" type="checkbox" name="requires_director_approval" id="requires_director_approval" value="1" {{ old('requires_director_approval') == 1 ? 'checked' : '' }}>
        ...
        Yêu cầu Giám đốc phê duyệt (Cấp 4)
                            ...
                            <div class="row mt-3">
                                <div class="col-md-2 form-group">
                                    ...
                                    <input type="number" name="signature_page" id="signature_page" class="form-control" value="{{ old('signature_page', 1) }}" min="1">
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <input type="number" name="signature_pos_x" id="signature_pos_x" class="form-control" value="{{ old('signature_pos_x', $defaultSignaturePositions['pos_x']) }}" step="0.01">
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <input type="number" name="signature_pos_y" id="signature_pos_y" class="form-control" value="{{ old('signature_pos_y', $defaultSignaturePositions['pos_y']) }}" step="0.01">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="number" name="signature_width" id="signature_width" class="form-control" value="{{ old('signature_width', $defaultSignaturePositions['width']) }}" step="0.01">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="number" name="signature_height" id="signature_height" class="form-control" value="{{ old('signature_height', $defaultSignaturePositions['height']) }}" step="0.01">
